...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    UISegmentedControl *colorControl = [[UISegmentedControl alloc] init];
    self.colorControl = [colorControl initWithItems: @[@"Red", @"Green", @"Blue"]];
    
    CGRect controlFrame = self.colorControl.frame;
    controlFrame.origin.x = 20;
    controlFrame.origin.y = 20;
//    controlFrame.size.width = newWidth;
//    controlFrame.size.height = newHeight;
    self.colorControl.frame = controlFrame;
